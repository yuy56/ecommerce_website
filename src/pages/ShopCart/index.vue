      ...
      <div class="cart-body">
        ...
        v-for="cart in cartInfoList" :key="cart.id">
          <li class="cart-list-con1">
            ...
            @change="updateChcked(cart,$event)">
          </li>
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" :value="cart.skuNum" @change="handler('change',$event.target.value*1,cart)" minnum="1" class="itxt">
  ...
  export default {
    ...
    methods:{
      ...
      handler:throttle(async function (type,disNum,cart){
        //type：为了区分这三个元素
        //目前diaNum形参：+ - 变化量（1，-1）input最终个数（并不是变化量）
        //cart：哪一个产品【身上有id】
        switch(type){
          case "add":
            //带给服务器变化量
